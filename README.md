...
\- MySQL: `localhost:3306` (db `banking\\\_db`, user `banking\\\_user`, pass `12345Bank`)
...
Es requisito tener instalado y corriendo  MySQL en `localhost:3306` con la BD `banking\\\_db`.
...
2\. Importar `postman\\\_collection/Banking.postman\\\_collection.json`.

3\. Importar `postman/Banking.postman\\\_environment.json`
